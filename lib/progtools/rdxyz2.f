C+----------------------------------------------------------------------
C
      SUBROUTINE RDXYZ2 (NDIM, LUNDAT, LUNERR, COMMENT, COLUMNS, MAXPTS,
...
C     COMMENT   -     C*1    I     ! or # (say) for commented-out lines or
C                                  trailing comments
...
C     11/23/16  DAS  COMMENT needed to be an argument when SMOOTH was
C                    changed to use # instead of !.  Keep it a single
C                    character for now, although any list of delimiters
C                    would have been preferable (too hazardous a change
C                    at this time). Renaming as RDXYZ2 avoids affecting
C                    users of RDXYZ other than SMOOTH.
C
