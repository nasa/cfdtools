...
C
C        (3)  Future mods: Provide for max. number of cycles? Handle
C             termination where the test is, rather than at end?
C
C     History..
C
C     12/31/83   RAK   Restructured and (partially) cleaned up. Notes
C                      on unanswered questions are sprinkled through-
C                      out the code.
C
C-----------------------------------------------------------------------
