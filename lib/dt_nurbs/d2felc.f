      SUBROUTINE D2FELC (CMEM, IMEM, DMEM, IDE, LENC, IER)

C     PURPOSE:
C        Fetch Length of Entity's character space
C
...
C
C     OUTPUT:
C        LENC     Length of the entity's character space
...
C     Long name alias:
C        ENTRY D2_FETCH_CMEM_LENGTH (CMEM, IMEM, DMEM, IDE, LENC, IER)

      CHARACTER         CMEM*(*)
      INTEGER           IMEM(*), IDE
      DOUBLE PRECISION  DMEM(*)

      INTEGER           IHDR, ITYP, LENC, IER
