      SUBROUTINE D2FELI (CMEM, IMEM, DMEM, IDE, LENI, IER)

C     PURPOSE:
C        Fetch Length of Entity's integer space
C
...
C
C     OUTPUT:
C        LENI     Length of the entity's integer space
...
C     Long name alias:
C        ENTRY D2_FETCH_IMEM_LENGTH (CMEM, IMEM, DMEM, IDE, LENI, IER)

      CHARACTER         CMEM*(*)
      INTEGER           IMEM(*), IDE
      DOUBLE PRECISION  DMEM(*)

      INTEGER           IHDR, ITYP, LENI, IER
