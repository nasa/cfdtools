...
!  Execution:
   ...
   write (20, '(2es15.7)') (xdata(i), ydata(i), i = 1, ndata)
...
!  Normalize the data x(:) & y(:) independently; they are probably s(:) & f(:):
   ...
   write (21, '(2es15.7)') (xdata(i), ydata(i), i = 1, ndata)
...
!  Denormalize the interpolations:
   ...
   write (22, '(2es15.7)') (xevaln(i), yeval(i), i = 1, neval)

   call usescale ('D', 1, neval, yeval, yeval, yeval, scale(ndim), &
                  shift(ndim), ier)

   write (23, '(2es15.7)') (xeval(i), yeval(i), i = 1, neval)
