...
!
!  Only forebodies are treated here.  Aft body generatrices can be more involved - see AFT_BODY and/or CAPSULE_GRID.
!
...
!        Defining parameters:
         ...
         real :: skirt_length                 ! From aft tangency point, >= 0 m
...
!        Local variables:
         ...
         real :: cone, cos_cone, sin_cone, Rb, Rn, Rs
...
!!!      capsule%rcenter_nose     = capsule%r_nose   ! Redundant
         ...
         if (.not. Apollo_type) write (*, '(a, 3x, 2f15.10)') &
